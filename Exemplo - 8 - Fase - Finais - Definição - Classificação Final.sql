...
-- Inserindo as 48 Selecoes na ClassificacaoGeral --
...
Select 'Classificação Final - World Champion, Runner-Up, Terceiro e Quarto' As 'Copa do Mundo 2026'
Union All
...
Select 'Classificação Final - Posicionamento - Seleções' As 'Copa do Mundo 2026'
Union All
Select Case When J.GolsSelecao1 > J.GolsSelecao2 Then '1º lugar: '+S1.NomeSelecao Else '1º lugar: '+S2.NomeSelecao End As 'Classificação'
From ClassificadosFinal C Inner Join Selecoes S1
                                           On C.CodigoSelecaoSorteio = S1.CodigoSelecao
...
Select 'Classificação Final - Performance Geral - Seleções - Considerando todas as fases disputadas' As 'Copa do Mundo 2026'
